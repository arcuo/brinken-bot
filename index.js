...
async function handleSlashCommand(interaction) {
	...
	try {
		...
		await globals.sendMessageToChannel({
			channelId: globals.DISCORD_TEST_CHANNEL_ID,
			message: `Error occurred during command execution: ${errorMessage}, and the command interaction was: ${stringifyglobals.DiscordClass(
				interaction,
			)}`,
		});
...
globals.setDiscordClient(discordClient);
